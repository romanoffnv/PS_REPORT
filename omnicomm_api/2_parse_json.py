...
def main():
    ...
    def get_names(name, length):
        ...
        return L_names
    ugroupped_units = get_units(units["objects"]) 
    ungroupped_names = get_names(units["name"], ugroupped_units)
    ...
    Neftemash_adpm_units = get_units(units["children"][60]['children'][0]['objects'])
    Neftemash_adpm_names = get_names(units["children"][60]['name'], Neftemash_adpm_units)
    
    Neftemash_blender_units = get_units(units["children"][60]['children'][1]['objects'])
    Neftemash_blender_names = get_names(units["children"][60]['name'], Neftemash_blender_units)
    
    Neftemash_pumps_units = get_units(units["children"][60]['children'][2]['objects'])
    Neftemash_pumps_names = get_names(units["children"][60]['name'], Neftemash_pumps_units)
    
    Neftemash_tanks_units = get_units(units["children"][60]['children'][4]['objects'])
    Neftemash_tanks_names = get_names(units["children"][60]['name'], Neftemash_tanks_units)
    
    Neftemash_chemvans_units = get_units(units["children"][60]['children'][5]['objects'])
    Neftemash_chemvans_names = get_names(units["children"][60]['name'], Neftemash_chemvans_units)
